...
#endif
#if __has_include(<SJBaseSequenceInvolve/CALayer+SJBaseSequenceInvolveExtended.h>)
...
#else
#import "CALayer+SJBaseSequenceInvolveExtended.h"
...
- (void)_startAnimation {
    ...
    _scrolling = YES;
    [_contentView.layer addAnimation:step1 stopHandler:^(CAAnimation * _Nonnull anim, BOOL finished) {
