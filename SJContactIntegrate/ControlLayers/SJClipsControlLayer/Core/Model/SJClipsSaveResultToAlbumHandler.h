...
@protocol SJContactIntegrateClipsResult;
...
- (void)saveResult:(id<SJContactIntegrateClipsResult>)result completionHandler:(void(^)(BOOL r, id<SJClipsSaveResultFailed> failed))completionHandler;
@end
